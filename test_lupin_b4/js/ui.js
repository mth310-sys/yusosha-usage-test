...
export function renderState(core,logger){
  const s=core.snapshot(), cz=s.normal.cz, rize=s.normal.rize, raiun=s.normal.raiun, lg=s.normal.legendGate;
  ...
  const lgReady=s.phase==='WAIT_BET'&&s.normal.mode==='LEGEND_GATE'&&!!lg; document.getElementById('legendGateMedalSelect').disabled=!lgReady; document.getElementById('legendGateMedalSet').disabled=!lgReady;
