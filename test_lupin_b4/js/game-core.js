...
import { NormalSystem } from './normal.js?v=step5b';
...
export class GameCore {
  ...
  stopReel(index) {
    ...
    this.phase='RESULT'; this.creditSystem.settle(this.pendingRole);
    const normal=this.normal.completeGame(), after=this.creditSystem.snapshot(), reels=this.reels.snapshot();
