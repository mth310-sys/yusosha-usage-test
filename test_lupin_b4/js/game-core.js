...
import { NormalSystem } from './normal.js?v=step3f';
...
export class GameCore {
  constructor({setting=1, seed=Date.now()} = {}) {
    ...
    this.normal = new NormalSystem(this.rng);
    this.gameNo = 0;
    this.phase = 'WAIT_BET';
    this.lastRole = null;
  ...
  stopReel(index) {
    ...
    const normal = this.normal.completeGame();
    ...
    const result = {
      ...
      consumedHold:normal.lastConsumedHold,
