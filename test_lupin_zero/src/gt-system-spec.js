export const GT_SYSTEM_SPEC = Object.freeze({
  ...
  extraBonus: Object.freeze({
    ...
    gamesRule: 'GT_REMAINING_GAMES_PLUS_GOLD_CHANCE_ADDED_GAMES',
    averageGames: 29.6,
    oddSymbolSetStockDenominator: null,
    oddSymbolSetStockPreferredReferenceDenominator: 202.6,
    oddSymbolSetStockConflictingReferenceDenominator: 4924.3,
    oddSymbolSetStockRateStatus: 'CONFLICT',
    automaticOddSymbolSetStockLotteryAllowed: false,
    goldRushDenominator: 4924.3,
    goldRushRateStatus: 'MULTI_SOURCE_MATCH',
  ...
  evidence: Object.freeze({
    ...
    extraBonusDurationDistribution: 'UNRESOLVED',
    extraBonusOddSymbolStockRate: 'CONFLICT',
    extraBonusGoldRushRate: 'MULTI_SOURCE_MATCH',
  ...
  policy: Object.freeze({
    ...
    autoRollExtraBonusDurationFromAverageOrMinimum: false,
    autoUseConflictedExtraBonusOddSymbolStockRate: false,
