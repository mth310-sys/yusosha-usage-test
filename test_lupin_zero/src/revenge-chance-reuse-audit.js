...
export const REVENGE_CHANCE_PRESENTATION_REUSE = Object.freeze({
  ...
  automaticSuccessMechanismSelection: false,
  presentationUse: 'SHOW_VERIFIED_STRUCTURE_WITHOUT_INVENTING_OCCURRENCE_TIMING_OR_ROUTE_SPLIT',
...
export const REVENGE_CHANCE_REUSE_AUDIT = Object.freeze({
  ...
  characterCollectionDestinationStatus: REVENGE_CHANCE_SPEC.characterCollectionDestination === 'LUPIN_BONUS' ? 'PUBLISHED_MATCH' : 'CONFLICT',
  directGoldenTimeRouteStatus: REVENGE_CHANCE_SPEC.directGoldenTimeRouteExists ? 'PUBLISHED_EXISTENCE_TRIGGER_UNRESOLVED' : 'CONFLICT',
  successMechanismSplitStatus: 'UNRESOLVED',
  ...
  autoSelectSuccessMechanism: false,
