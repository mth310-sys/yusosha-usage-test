export const VERIFIED_SPEC = Object.freeze({
  ...
  modeProfiles: Object.freeze({
    ...
    goldenTime: Object.freeze({ setGamesApprox:40,pureIncreaseCoinsPerGame:2.0,continuationExpectationPercent:Object.freeze({min:80.4,max:83.3}),expectedSets:Object.freeze({min:5.1,max:6.0}) })
  }),
  chanceZones: Object.freeze({
    ...
    sevenZone:Object.freeze({ category:'CONFIRMED_ART_PRECURSOR',confirmedDestination:'GOLDEN_TIME',games:null,automaticEntryProbability:null })
  }),
  ...
  physicalMainReels:Object.freeze({
    ...
    confirmedMiddleLinePattern:Object.freeze({ role:'MB',left:'次元',center:'五エ門',right:'ルパン' }),
    targetPrompt:Object.freeze({ label:'メインリールを狙え',target:'SPECIAL_SYMBOL',successConsequence:'LONG_FREEZE_AND_LEGEND_GATE',exactSpecialSymbolArtwork:null,exactStopPattern:null }),
