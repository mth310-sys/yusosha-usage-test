...
test('EXTRA bonus progression rejects corrupt counters', async ({ page }) => {
  ...
  const result = await page.evaluate(async () => {
    ...
    const corrupt = [
      { field: 'extraGameCount', value: '3' },
      { field: 'extraGameCount', value: 3.5 },
      { field: 'extraGameCount', value: -1 },
      { field: 'extraGameCount', value: Infinity },
      { field: 'extraRemainingGames', value: '7' },
      { field: 'extraRemainingGames', value: 7.5 },
      { field: 'extraRemainingGames', value: -1 },
      { field: 'extraRemainingGames', value: Infinity },
      { field: 'extraStockLotteryEvents', value: '3' },
      { field: 'extraStockLotteryEvents', value: 3.5 },
      { field: 'extraStockLotteryEvents', value: -1 },
      { field: 'extraStockLotteryEvents', value: Infinity },
      { field: 'extraStockHits', value: '1' },
      { field: 'extraStockHits', value: 1.5 },
      { field: 'extraStockHits', value: -1 },
      { field: 'extraStockHits', value: Infinity }
    ];
